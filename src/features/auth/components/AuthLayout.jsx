...
export default function AuthLayout() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4 py-12 overflow-hidden bg-surface">
      ...
      <div
        className="auth-orb w-96 h-96 bg-terracotta"
        style={{ top: '-8rem', right: '-6rem', animationDelay: '0s' }}
      />
      <div
        className="auth-orb w-72 h-72 bg-sand"
        style={{ bottom: '-4rem', left: '-4rem', animationDelay: '2s' }}
      />
      <div
        className="auth-orb w-48 h-48 bg-clay"
        style={{ top: '40%', left: '5%', animationDelay: '4s', opacity: 0.15 }}
      />
