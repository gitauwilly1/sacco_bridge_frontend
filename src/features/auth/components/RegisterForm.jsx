  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="text-center">
        <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-sand-light">
          <span className="text-2xl font-bold text-terracotta">SB</span>
        </div>
        <CardTitle className="text-2xl">Create Account</CardTitle>
        <CardDescription>Join Sacco Bridge and start your cooperative journey</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
              ...
              render={({ field }) => (
                <FormItem className="flex items-start gap-2">
                  ...
                  <label className="text-sm text-gray-500 leading-tight">
                    I accept the{' '}
                    <a href="/legal/terms" className="text-terracotta hover:underline">Terms of Service</a>
                    {' '}and{' '}
                    <a href="/legal/privacy" className="text-terracotta hover:underline">Privacy Policy</a>
                  </label>
                  <FormMessage />
                </FormItem>
              )}
