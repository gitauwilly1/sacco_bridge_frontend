...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['favicon.svg', 'apple-touch-icon.svg', 'firebase-messaging-sw.js'],
      manifest: {
        name: 'Sacco Bridge',
        short_name: 'SaccoBridge',
        description: 'Cooperative finance platform for chamas and SACCO investments',
        theme_color: '#C67B5C',
        background_color: '#F5E6D3',
        display: 'standalone',
        orientation: 'portrait-primary',
        start_url: '/',
        gcm_sender_id: '___FIREBASE_MESSAGING_SENDER_ID___',
        icons: [
          {
            src: '/icon-192.svg',
            sizes: '192x192',
